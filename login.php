        ...
        <div class="app-row-center">
            <div class="app-col">  
                ...
                <div class="mb-3">
                    ...
                    <input type="email" class="form-control" id="email" name="email" placeholder = "Enter e-mail account" value="<?php echo $email ; ?>">
                ...
                <p class="acct"> Don't have an account? <a href="register.php">Register Here</a></p>
            </div>
        </div>
    </div>
<?php
